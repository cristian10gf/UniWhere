...
# Inference-only copy of Encoder, Head, Regressor from preprocesamiento/models/ace/ace_network.py.
# Training and visualization code removed. See original for full version.
...
class Regressor(nn.Module):
    ...
    The network predicts 3D scene coordinates, the output is subsampled by a factor of 8 compared to the input.
    """
